...
Route::get('checkedGroup/{branchID}','API\GroupController@indexChecked');
...
Route::patch('updateRateAndScore/{branchID}/{groupID}','API\RateAndScoreController@update')->middleware('auth:api');
